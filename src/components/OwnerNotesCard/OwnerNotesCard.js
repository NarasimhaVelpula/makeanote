...
import NoteModal from '../OwnerNotesModal/OwnerNotesModal';
...
export default function OwnerNotesCard(props) {
  ...
  return (
    ...
    <NoteModal modalState={modalState} handleModalClose={handleModalClose} handleContributeModalOpen={handleContributeModalOpen} card={props.card} giveCard={giveCard} noteId={noteId}/>
