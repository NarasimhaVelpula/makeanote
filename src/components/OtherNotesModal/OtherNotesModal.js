...
import ModalCardFooter from '../CardFooter/OtherCardFooter';
...
export default function OtherNotesModal(props) {
  const classes = useStyles();
  const {modalState,handleModalClose,handleContributeModalOpen,giveCard,noteId,editModalCard}=props
