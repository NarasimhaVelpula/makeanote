...
import NoteCard from '../OtherNotesCard/OtherNotesCard'
...
function OtherNotes() {
    ...
    useEffect(()=>{
        axios.post('/contribution/getContributedNotes',{
            authToken:authToken
        })
        .then(res=>{
            console.log(res.data)
            setCards(res.data.sendingNotes)
            setAccess(res.data.noteAccess)
